...
contract("Marketplace", ([deployer, seller, buyer]) => {
  ...
  describe("deployment", async () => {
    ...
    it("has a name", async () => {
      ...
      assert.equal(name, "lakshay Marketplace");
    });
  });
  ...
  describe("products", async () => {
    ...
    it("creats products", async () => {
      ...
      await marketplace.createProduct("", web3.utils.toWei("2", "ether"), {
        from: seller,
      }).should.be.rejected;
    ...
    it("lists products", async () => {
      ...
      assert.equal(product.price, "2000000000000000000", "price is correct");
